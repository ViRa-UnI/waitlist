...
import 'category_editing_supabase_model.dart';
export 'category_editing_supabase_model.dart';

class CategoryEditingSupabaseWidget extends StatefulWidget {
  const CategoryEditingSupabaseWidget({
    Key? key,
    required this.uID,
  }) : super(key: key);
  ...
  @override
  _CategoryEditingSupabaseWidgetState createState() =>
      _CategoryEditingSupabaseWidgetState();
}

class _CategoryEditingSupabaseWidgetState
    extends State<CategoryEditingSupabaseWidget> {
  late CategoryEditingSupabaseModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CategoryEditingSupabaseModel());
