...
import '/components/app_menu_comp_widget.dart';
        ...
        body: SafeArea(
          ...
          child: Align(
            ...
            child: Padding(
              ...
              child: StreamBuilder<List<RestaurantMenuRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<RestaurantMenuRecord> columnRestaurantMenuRecordList =
                      snapshot.data!;
                  return Column(
                    ...
                    children: List.generate(
                        columnRestaurantMenuRecordList.length, (columnIndex) {
                      final columnRestaurantMenuRecord =
                          columnRestaurantMenuRecordList[columnIndex];
                      return Align(
                        ...
                        child: StreamBuilder<List<RestaurantMenuRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<RestaurantMenuRecord>
                                rowRestaurantMenuRecordList = snapshot.data!;
                            // Return an empty Container when the item does not exist.
                            if (snapshot.data!.isEmpty) {
                              return Container();
                            }
                            final rowRestaurantMenuRecord =
                                rowRestaurantMenuRecordList.isNotEmpty
                                    ? rowRestaurantMenuRecordList.first
                                    : null;
                            return Row(
                              mainAxisSize: MainAxisSize.max,
