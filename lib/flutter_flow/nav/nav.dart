...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => _RouteErrorBuilder(
        state: state,
        child: appStateNotifier.loggedIn ? MainPageWidget() : HomePageWidget(),
      ),
      routes: [
        FFRoute(
          name: '_initialize',
          ...
          routes: [
            ...
            FFRoute(
              name: 'guestEntry',
              path: 'guestEntry',
              builder: (context, params) => GuestEntryWidget(),
            ),
            FFRoute(
              name: 'ListTable',
              path: 'listTable',
              builder: (context, params) => ListTableWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              ...
              path: 'AppMenuPage',
              requireAuth: true,
              builder: (context, params) => AppMenuPageWidget(),
            ),
            FFRoute(
              name: 'AddMenuItem',
              path: 'AddMenuItem',
